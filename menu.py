...
class Menu(Screen):
    def __init__(self, **kwargs):
        ...
        btn_icon = MDFloatingActionButton(icon="plus", halign="right", pos_hint={'center_x': .81, 'y': 1.27})
        btn_flat1 = MDRectangleFlatButton(text="Lunch\n___Recommended cal\n___cal consumed ", halign="left",
                                          pos_hint={'center_x': 0.5, 'y': 1}, size_hint=(.78, 0))
        btn_icon2 = MDFloatingActionButton(icon="plus", halign="right", pos_hint={'center_x': .81, 'y': 1.02})
        btn_flat2 = MDRectangleFlatButton(text="Snacks\n___Recommended cal\n___cal consumed ", halign="left",
                                          pos_hint={'center_x': 0.5, 'y': .75}, size_hint=(.78, 0))
        btn_icon3 = MDFloatingActionButton(icon="plus", halign="right", pos_hint={'center_x': .81, 'y': 0.77})
        btn_flat3 = MDRectangleFlatButton(text="Dinner\n___Recommended cal\n___cal consumed ", halign="left",
                                          pos_hint={'center_x': 0.5, 'y': 0.5}, size_hint=(.78, 0))
        btn_icon4 = MDFloatingActionButton(icon="plus", halign="right", pos_hint={'center_x': .81, 'y': 0.52})
...
class Profile(Screen):
    def __init__(self, **kwargs):
        ...
        img = Image(source='profile1.jpeg', size_hint=(.15, .31), pos_hint={'center_x': 0.51, 'y': 1.55})
