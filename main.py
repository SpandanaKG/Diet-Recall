...
class Menu(Screen):
    def __init__(self,**kwargs):
        ...
        eat = MDRectangleFlatButton(text="Eaten\n\n____kcal", size_hint=(.15,.31), pos_hint={'center_x': 0.21, 'y': 1.55})
        eat1 = MDRectangleFlatButton(text="Calories\n\n Remaining\n\n____kcal", size_hint=(.15, .31), pos_hint={'center_x': 0.79, 'y': 1.55})
        btn_flat = MDRectangleFlatButton(text="BreakFast\n___Recommended cal\n___cal consumed ", halign="left", pos_hint={'center_x' : 0.5,'y': 1.25}, size_hint=(.78, 0),on_release = self.on_button_press)
        btn_icon = MDIconButton(icon="plus", halign="right", pos_hint={'center_x': .81, 'y': 1.27})
        btn_flat1 = MDRectangleFlatButton(text="Lunch\n___Recommended cal\n___cal consumed ", halign="left", pos_hint={'center_x' : 0.5, 'y': 1}, size_hint=(.78, 0))
        btn_icon2 = MDIconButton(icon="plus",halign="right",pos_hint={'center_x':.81,'y':1.02})
        btn_flat2 = MDRectangleFlatButton(text="Snacks\n___Recommended cal\n___cal consumed ",halign="left", pos_hint={'center_x' : 0.5, 'y': .75}, size_hint=(.78, 0))
        btn_icon3 = MDIconButton(icon="plus",halign="right",pos_hint={'center_x':.81,'y':0.77})
        btn_flat3 = MDRectangleFlatButton(text="Dinner\n___Recommended cal\n___cal consumed ",halign="left", pos_hint={'center_x' : 0.5, 'y': 0.5}, size_hint=(.78, 0))
        btn_icon4 = MDIconButton(icon="plus",halign="right",pos_hint={'center_x':.81,'y':0.52})
        btn1 = MDFlatButton(text="Favorites", pos_hint={'center_x': .2, 'center_y': 0.30},md_bg_color="#00e77a", on_release = self.on_button_press)
        btn2 = MDFlatButton(text="Water Tanker", pos_hint={'center_x': .5, 'center_y': 0.30}, md_bg_color="#00e77a", on_release=self.on_button_press1)
        btn3 = MDFlatButton(text="Meal Planner", pos_hint={'center_x': .8, 'center_y': 0.30},md_bg_color="#00e77a", on_release = self.on_button_press2)
        self.add_widget(eat)
